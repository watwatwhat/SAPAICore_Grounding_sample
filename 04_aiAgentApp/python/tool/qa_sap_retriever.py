...
class QASapRetriever(BaseModel):
    """
    Retriever for QA History using SAP Embeddings.
    """
    ...
    def get_related_qas(self, query: str):
        ...
        related_qas = hana_repository.get_related_qas_using_sap_embedding(query=query, top_k=3)
